...
namespace Gadi.Data.Services
{
    ...
    /// </summary>
    public class AuthorizationDataService : GadiDataService, IAuthorizationDataService
    {
        public AuthorizationDataService(IDatabaseFactory<GadiDatabase> databaseFactory, IGenericDataService<DbContext> genericDataService) : base(databaseFactory, genericDataService)
        {
        }
