...
namespace Gadi.Models.Identity
{
    /// <summary>
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public class CustomInitializer : IDatabaseInitializer<ApplicationDbContext>
        {
            public void InitializeDatabase(ApplicationDbContext context)
            {
                ...
                var data2 = roleManager.Roles.ToList();
                if (!userManager.Users.Any(u => u.UserName == "superadmin@gadiseekho.com") && roleManager.Roles.Any(r => r.Name == "SuperUser") && context.ApplicationPermissions.Any(r => r.Name == "SuperUser"))
                {
                    var user = new ApplicationUser
                    {
                        UserName = "superadmin@gadiseekho.com",
                        Email = "superadmin@gadiseekho.com",
                        EmailConfirmed = true,
                    };
