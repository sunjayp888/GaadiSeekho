(function () {
    ...
    angular
        .module('Gadi')
        .controller('DrivingSchoolProfileController', DrivingSchoolProfileController);

    DrivingSchoolProfileController.$inject = ['$window', 'DrivingSchoolProfileService', 'Paging', 'OrderService', 'OrderBy', 'Order'];
